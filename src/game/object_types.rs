...
pub async fn create_object_types(
    ...
    obj_types.insert(
        ...
        ObjectType::new(
            21,
            "Gravity Pad",
            load_texture("./Resources/objects/pads/gravity-pad.png")
                .await.expect("Failed to load gravity pad texture"),
            obj_btn_offset,
            obj_types.len() as u16
        )
    );
    ...
    obj_types.insert(
        ...
        ObjectType::new(
            22,
            "Gravity Orb",
            load_texture("./Resources/objects/orbs/gravity-orb.png")
                .await.expect("Failed to load gravity orb texture"),
            obj_btn_offset,
            obj_types.len() as u16
        )
    );
